...
Welcome to my [personal website](https://rutvikkalathiya.com)! This is an [MIT licensed](https://github.com/rutvik-kalathiya/personal-site/blob/main/LICENSE) React-based Jamstack application. It offers a simple interface, easy modifications, static export capabilities, and free automatic deployments via [GitHub Pages](https://pages.github.com/).
...
- Kudos to [@notrueblood](https://github.com/notrueblood)[<sup>[1]</sup>](https://github.com/rutvik-kalathiya/personal-site/pull/218) and [@sjhsieh](https://github.com/sjhsieh)[<sup>[2]</sup>](https://github.com/rutvik-kalathiya/personal-site/issues/168) for their constructive feedback.
